...
//Reading the input and searching on API
...
// my api key => 5234304046688237
const fetchAllSuperHero = async (searchText) => {
    let url = `https://www.superheroapi.com/api.php/5234304046688237/search/${searchText}`;
    try {
...
// Creating a div to searchList with the results of api
...
// Event keyup to show in searchList the searched hero on input
...
//Event to show hero details searched
...
//Function to show hero details searched on tab-body
